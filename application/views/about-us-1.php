			...
			<div class="row">
				<div class="col-md-6">
					<div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="100">
						<span class="top-sub-title pink-color">SANTAL</span>

						<h2 class="font-weight-bold text-6 mb-3">Qui Sommes Nous</h2>
					</div>
					<p class="lead mb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">Lorem ipsum dolor sit amet, consectetur adipiscing
						elit.
						Phasellus blandit massa enim. Nullam id varius nunc.</p>

					<p class="text-color-light-3 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500">Notre boutique en ligne spécialisée dans la vente de produits cosmétiques en Tunisie. Découvrir nos crèmes pour le visage, nos huiles essentielles et végétales pour les cheveux et le corps et plein d'autres produits au meilleurs prix.</p>

					<a href="contact-us-1.html" class="btn btn-outline btn-rounded btn-v-3 btn-h-4 font-weight-bold text-0 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="700">CONTACTEZ-NOUS</a>
				</div>
								...
								<div class="row m-0">
									<div class="col-sm-6">
										<div class="counter text-dark my-4 pb-1">
											...
											<label class="font-weight-light">Clients Satisfaits</label>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="counter text-dark my-4 pb-1">
											<strong data-to="15">15</strong>
											<label class="font-weight-light">Ans d'activité</label>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="counter text-dark my-4 pt-1">
											<strong data-to="352">352</strong>
											<label class="font-weight-light">Coupons Utilisés</label>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="counter text-dark my-4 pt-1">
											<strong data-to="178">178</strong>
											<label class="font-weight-light">Produits</label>
										</div>
									</div>
								</div>
							</div>
		...
		<div class="container">
			<div class="row">
					...
					<div class="card border-0 h-100 py-5">
						<div class="card-body p-5">
							...
							<p class="text-color-light opacity-7 mb-4">Lorem ipsum dolor sit amet, consectetur
								...
								ipsum
								dolor sit amet.</p>
							<a href="portfolio-sidebar-right.html" class="learn-more text-color-light font-weight-semibold">
				...
				<div class="col-md-6 p-0 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="200">
					<div class="image-frame min-height-300 h-100" data-plugin-image-background data-plugin-options="{'imageUrl': '<?= base_url() ?>assets/img/generic/shampo.jpg'}"></div>
				</div>
			</div>
		</div>
	</section>
	<section class="section background-pink py-0 ">
		<div class="container">
			<div class="row background-pink">
				<div class="col-md-6 order-2 order-md-1 p-0 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="600">
					<div class="image-frame min-height-300 h-100" data-plugin-image-background data-plugin-options="{'imageUrl': '<?= base_url() ?>assets/img/generic/lipsticks.jpg'}"></div>
				</div>
					...
					<div class="card background-pink border-0 h-100 py-5">
						<div class="card-body p-5 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="400">
							...
							<p class="text-color-light opacity-7 mb-4">Lorem ipsum dolor sit amet, consectetur
								...
								ipsum
								dolor sit amet.</p>
							<a href="contact-us-3.html" class="learn-more text-color-light font-weight-semibold">
								<!-- <i class="fas fa-angle-right"></i> -->
							</a>
						</div>
					</div>
		...
		<div class="container">
			<div class="row py-5 mb-5 px-3 px-sm-0 ">
				<div class="col order-1 scale-1 p-0">
					<img src="<?= base_url() ?>assets/img/others/1.jpg" class="img-fluid appear-animation" alt="" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="1000" />
				</div>
				<div class="col order-5 scale-1 p-0">
					<img src="<?= base_url() ?>assets/img/others/2.jpg" class="img-fluid appear-animation" alt="" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="1000" />
				</div>
				<div class="col order-2 scale-2 p-0">
					<img src="<?= base_url() ?>assets/img/others/3.jpg" class="img-fluid appear-animation" alt="" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="800" />
				</div>
				<div class="col order-4 scale-2 z-index-1 p-0">
					<img src="<?= base_url() ?>assets/img/others/4.jpg" class="img-fluid appear-animation" alt="" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="800" />
				</div>
				<div class="col order-3 scale-3 z-index-2 p-0">
					<img src="<?= base_url() ?>assets/img/others/5.jpg" class="img-fluid appear-animation" alt="" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600" />
				</div>
			</div>
			<div class="spacer pt-sm-1 pt-md-4 pt-lg-5"></div>
			<h1 class="text-center text-color-light">Notre environnement</h1>
			<!-- <div class="row align-items-baseline mt-5">
						<div class="col-lg-4">
							<div class="icon-box appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="300">
								...
								<div class="icon-box-info">
									<span class="top-sub-title text-color-light opacity-6">LOREM IPSUM DOLOR SIT</span>
									<h2 class="font-weight-bold text-color-light text-4 mb-3">Exclusive Designs</h2>
									<p class="text-color-light opacity-6">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa enim. Nullam id varius.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="icon-box appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">
								<div class="icon-box-icon pr-3">
									<img width="42" src="vendor/linear-icons/select.svg" alt="" data-icon data-plugin-options="{'color': '#FFF', 'animated': true, 'delay': 900}" />
								</div>
								<div class="icon-box-info">
									<span class="top-sub-title text-color-light opacity-6">LOREM IPSUM DOLOR SIT</span>
									<h2 class="font-weight-bold text-color-light text-4 mb-3">Amazing Features</h2>
									<p class="text-color-light opacity-6">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa enim. Nullam id varius.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="icon-box appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="300">
								<div class="icon-box-icon pr-3">
									<img width="42" src="vendor/linear-icons/code.svg" alt="" data-icon data-plugin-options="{'color': '#FFF', 'animated': true, 'delay': 1200}" />
								</div>
								<div class="icon-box-info">
									<span class="top-sub-title text-color-light opacity-6">LOREM IPSUM DOLOR SIT</span>
									<h2 class="font-weight-bold text-color-light text-4 mb-3">Clean Source Code</h2>
									<p class="text-color-light opacity-6">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa enim. Nullam id varius.</p>
								</div>
							</div>
						</div>
